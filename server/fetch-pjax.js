(function (global, factory) {
	...
	function baseCreate$1(proto) {
	  return isObject$2(proto) ? objectCreate$1(proto) : {};
	}
	 ...
	 * @returns {Function} Returns `wrapper`.
	 */
	var setWrapToString$1 = !defineProperty$1 ? identity$1 : function(wrapper, reference, bitmask) {
	  var source = (reference + '');
	...
	function curry(func, arity, guard) {
	  ...
	  var result = createWrap$1(func, CURRY_FLAG$1, undefined, undefined, undefined, undefined, undefined, arity);
	...
	class FetchPjax {
		...
		handlePopState(e) {
			...
			if (
				...
				!lodash_isnil(contents) &&
				contents.length &&
				lodash_isstring(contents)
			) {
